...
//import InputBasic from './AddCurrency'
 import HorizontalForm from './AddSubCategory'
import EditForm from './EditSubCategory'
...
const handleDelete = (data) => {
  ...
  const CustomPagination = () => (
    <ReactPaginate
      ...
      pageCount={searchValue.length ? filteredData.length / 7 : subCategoryData.length / 7 || 1}
      breakLabel={'...'}
  ...
  return (
    ...
    <Card>
      <CardHeader className='border-bottom'>
        <CardTitle tag='h4'>Sub Category List</CardTitle>
