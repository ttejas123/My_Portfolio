...
<Card>
<CardHeader>
  <CardTitle tag='h1'>My Rights and Permissions</CardTitle>
</CardHeader>
<CardBody>
<Row>
<Col sm='12'>
                              ...
                              <Table borderless striped responsive>
                                ...
                                <tbody>
                                  <tr>
                                    <td>Master</td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='master-1' label='' defaultChecked />
                                    </td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='master-2' label='' />
                                    </td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='master-3' label='' />
                                    </td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='master-4' label='' />
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Reports</td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='reports-1' label='' />
                                    </td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='reports-2' label='' defaultChecked />
                                    </td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='reports-3' label='' />
                                    </td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='reports-4' label='' />
                                    </td>
                                    </tr>
                                  <tr>
                                    <td>Users</td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='user-1' label='' defaultChecked />
                                    </td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='user-2' label='' />
                                    </td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='user-3' label='' defaultChecked />
                                    </td>
                                    <td>
                                      <CustomInput disabled type='checkbox' id='user-4' label='' />
                                    </td>
                                  </tr>
                                </tbody>
                              </Table>
