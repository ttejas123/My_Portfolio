...
// ** Table Data & Columns
import { ReplacementRequestData } from './data'
...
//   }
  ...
  const CustomPagination = () => (
    <ReactPaginate
      ...
      pageCount={searchValue.length ? filteredData.length / 7 : ReplacementRequestData.length / 7 || 1}
      breakLabel='...'
    ...
    <Fragment>
      ...
      <Card className='mx-1'>
        ...
        <CardHeader className='flex-md-row flex-column align-md-items-center align-items-start border-bottom'>
          <CardTitle tag='h4'>Replacement Requests</CardTitle>
        ...
        <DataTable
          ...
          data={searchValue.length ? filteredData : ReplacementRequestData}
