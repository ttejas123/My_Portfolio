...
import { Row, Col, Card, CardBody, Table, CardHeader, CardTitle, Input, Label, Button, Form } from 'reactstrap'
...
const FromExcelSheetTab = () => {
  ...
  return (
    ...
    >
         <CardHeader>
  <CardTitle tag='h1'>Import From Excel</CardTitle>
</CardHeader>
...
export default FromExcelSheetTab
