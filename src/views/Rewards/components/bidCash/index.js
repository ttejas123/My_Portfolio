...
import { MoreVertical, User, Users, Edit, Calendar, FileText, Archive, Trash,  MapPin, DollarSign, X, Plus, StopCircle  } from 'react-feather'
    ...
    <Card>
      <Row>
        ...
        <Col sm='12' className="d-flex justify-content-between pl-5 pt-2 pr-5">
          <h2 className="mb-1">Add BidCash</h2>
      ...
      <Col sm='12' className='d-flex justify-content-between pr-3'>
        ...
        <div className='mb-2 d-flex flex-column justify-content-end align-items-end'>
              ...
              <div className='d-flex '>
                  ...
                  <h4 className='mb-0'><span className='font-weight-bold'><StopCircle style={{color: 'yellow'}}  size={23} /></span></h4>
      ...
      <Col sm='12'>
        <Form onSubmit={e => e.preventDefault()}>
          <Row>
            ...
            <Col md='6' sm='12'>
              <FormGroup>
                <Label for='amount'>Enter Bidcash</Label>
                <InputGroup>
