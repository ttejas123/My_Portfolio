        ...
        <div className='border-bottom'>
          <UncontrolledAlert className='mx-2 text-left' color='primary'>
              <div className='alert-body'>
                ...
                <br /><br />
                <ul>
                  <li><b> Maximum Use Of Bid Coin Is Depended On Category </b></li>
                  <li><b> You Can't Share Bid Coin With Other People </b></li>
                  <li><b> Bid Coin is Bidoya Currency  </b></li>
                  <li><b> No Refund </b></li>
                </ul>
              </div>
