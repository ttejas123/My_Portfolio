...
import { Card, CardBody, CardText, CardHeader, Button, Badge, CustomInput, InputGroupAddon, Input, InputGroupText, Row, Col, Modal, ModalHeader, ModalBody, ModalFooter } from 'reactstrap'
...
const direction = 'ltr'
                    ...
                    <div className='item-options mb-0'>
                      <Row>
                        ...
                        <Col md='3' sm='5'>
                          ...
                          <CardBody className='px-0'>
                              <div>
                              <Button style={{width:"100px"}} className='mb-1 remove-wishlist' color='primary' onClick={() => handleSampleClick()}>
                              ...
                              <CardBody className='px-0 '>
                              <div>
                               <Button style={{width:"100px"}} className='mb-1 remove-wishlist' color='primary' onClick={() => handleBidClick()}>
  ...
  <>
    <Modal isOpen={modal} toggle={() => setModal(!modal)}>
          <ModalHeader toggle={() => setModal(!modal)}>Reject Bid</ModalHeader>
          <ModalBody>
         Rejecting Action cannot be undone, are you Sure
          </ModalBody>
