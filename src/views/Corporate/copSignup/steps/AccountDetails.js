  ...
  return (
    <Fragment>
      <div className='content-header'>
        <h5 className='mb-0'>Corporate Details</h5>
        <small className='text-muted'>Enter Your Corporate Details.</small>
      </div>
      <Form onSubmit={e => e.preventDefault()}>
        <Row>
          <FormGroup tag={Col} md='6'>
            ...
            <Input type='text' name={`username-${type}`} id={`username-${type}`} placeholder='Google' />
          </FormGroup>
          <FormGroup tag={Col} md='6'>
            <Label className='form-label' for={`Type-${type}`}>
              Type
            </Label>
            <Input type='text' name={`Type-${type}`} id={`Type-${type}`} placeholder='' />
          </FormGroup>
          <FormGroup tag={Col} md='6'>
