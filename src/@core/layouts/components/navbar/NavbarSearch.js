...
import { Sun, Moon, Menu, Search, Bell, Home, Package, Book, LogIn, ShoppingCart, Key, Grid, Archive } from 'react-feather'
...
const NavbarUser = props => {
  ...
  let seller = true
  useSelector(state => { 
    seller = state.StatusBS.Seller
    data = state.loginOut.flag 
  }) 
    ...
    <ul className='nav navbar-nav' style={{marginTop: '8px'}} >
          ...
          <div className={LoginWithJWT === null || LoginWithJWT.jwt === 400 ? ("d-none") : ("d-flex ")}>
              ...
              {SellerData === true ? (
                ...
                <small className='user-name h6 d-none d-lg-block' style={{ color:'black'}}><ProductDropDown HideMobileMenu={HideMobileMenu} /></small> 
