...
import { User, Mail, Home, Box, Package, AlertCircle, Map, Book, PlusCircle, Image, ShoppingCart, CheckSquare, MessageSquare, Settings, CreditCard, HelpCircle, Power, Archive } from 'react-feather'
